...
public class HenServiceTest {
    ...
    @Test
    void testGetAllHens() {
        HenModel hen = new HenModel(1L, "Layer", LocalDate.now(), 100, "A", 1L);
    ...
    void testFindByArrivalDate() {
        ...
        HenModel hen  = new HenModel(1L, "Layer", date, 100, "A", 1L);
    ...
    @Test
    void testCreateHen() {
        HenModel hen       = new HenModel(null, "Layer", LocalDate.now(), 100, "A", 1L);
        HenModel savedHen  = new HenModel(1L, "Layer", hen.getArrivalDate(), 100, "A", 1L);
    ...
    @Test
    void testUpdateHen() {
        HenModel existingHen = new HenModel(1L, "Broiler", LocalDate.now(), 50, "I", 2L);
        HenModel updatedData = new HenModel(null, "Layer", LocalDate.now(), 100, "A", 1L);
        HenModel updatedHen  = new HenModel(1L, "Layer", updatedData.getArrivalDate(), 100, "A", 1L);
    ...
    void testDeactivateHen() {
        HenModel hen         = new HenModel(1L, "Layer", LocalDate.now(), 100, "A", 1L);
        HenModel deactivated = new HenModel(1L, "Layer", hen.getArrivalDate(), hen.getQuantity(), "I", hen.getShedId());
    ...
    void testActivateHen() {
        HenModel hen       = new HenModel(1L, "Layer", LocalDate.now(), 100, "I", 1L);
        HenModel activated = new HenModel(1L, "Layer", hen.getArrivalDate(), hen.getQuantity(), "A", hen.getShedId());
